...
Blockly.ScratchMsgs.locales["en"] =
{
    ...
    "CONTROL_SWITCH": "switch %1",
    "CONTROL_CASE": "case %1",
    "CONTROL_CASE_FALLTHROUGH": "case %1",
    ...
    "MOTION_POINTTOWARDS_XY": "point towards x: %1 y: %2",
    "MOTION_POINTTOWARDS_XYFROM": "point towards x: %1 y: %2 from x: %3 y: %4",
    ...
    "PROCEDURES_TO_STATEMENT": "Change To Stacked Block",
    "PROCEDURES_DOCS": "How to use return",
...
Blockly.ScratchMsgs.locales["zh-cn"] =
{
    ...
    "MOTION_POINTTOWARDS_XYFROM": "面向 x: %1 y: %2 从 x: %3 y: %4",
    ...
    "PROCEDURES_TO_REPORTER": "更改为报告积木",
    "PROCEDURES_TO_STATEMENT": "更改为堆叠积木",
    "PROCEDURES_DOCS": "如何使用返回",
